export const queryKeys = {
  ...
  agents: {
    ...
    byProject: (projectId: string) => ["projects", projectId, "agents"] as const,
    messages: (projectId: string, agentId: string) =>
      ["projects", projectId, "agents", agentId, "messages"] as const,
  },
  tasks: {
